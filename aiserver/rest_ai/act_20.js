...
exports.process = function(state)
{
	...
	{
		state.result.code = 'rp_20_99_decided_full';
	...
	{
		state.result.code = 'rp_20_99_decided_mushrooms';
	...
	if (state.result.tokens.includes('e_sausage'))
	{
		state.result.code = 'rp_20_99_decided_sausage';
	...
	{
		state.result.code = 'rp_20_99_decided_meat_veg';
	...
	{
		state.result.code = 'rp_20_99_considering_topping';
	...
	{
		state.result.code = 'rp_20_99_considering_hawaiin';
	...
	{
		state.result.code = 'rp_20_99_considering_combo';
	...
	{
		state.result.code = 'rp_20_99_considering_crap';
	...
	{
		state.result.code = 'rp_20_99_considering_fish';
	...
	{
		state.result.code = 'rp_20_99_considering_dog';
	...
	{
		state.result.code = 'rp_20_99_considering_bird';
	...
	{
		state.result.code = 'rp_20_99_self_discovery';
	...
	{
		state.result.code = 'rp_20_85_impatient';
	...
	{
		state.result.code = 'rp_20_86_fed_up';
